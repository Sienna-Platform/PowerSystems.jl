...
const _CONTAINS_SHOULD_ENCODE = Union{Component, MarketBidCost, MarketBidTimeSeriesCost, ImportExportCost, ImportExportTimeSeriesCost}  # PSY types with fields that we should_encode_as_uuid
