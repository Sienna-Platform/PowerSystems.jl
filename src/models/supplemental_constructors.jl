...
function ACBus(
    ...
    return ACBus(
        ...
        name,
        available,
        get_enum_value(ACBusTypes.Value, bustype),
        angle,
        voltage,
        voltage_limits,
        base_voltage,
...
function DiscreteControlledACBranch(
    ...
    return DiscreteControlledACBranch(
        ...
        x,
        rating,
        get_enum_value(DiscreteControlledBranchType.Value, discrete_branch_type),
        get_enum_value(DiscreteControlledBranchStatus.Value, branch_status),
        ext,
        internal,
    )
end
...
function FACTSControlDevice(
    ...
    return FACTSControlDevice(
        ...
        available,
        bus,
        get_enum_value(FACTSOperationModes.Value, control_mode),
        voltage_setpoint,
        max_shunt_current,
        reactive_power_required,
        services,
