...
"""Get [`ConstantReserve`](@ref) `requirement`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_requirement(value::ConstantReserve) = get_value(value, Val(:requirement), Val(:mva), DEFAULT_UNITS)
