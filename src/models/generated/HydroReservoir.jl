...
"""
    mutable struct HydroReservoir <: Device
        ...
        level_data_type::ReservoirDataType.T
        ext::Dict{String, Any}
...
- `level_data_type::ReservoirDataType.T`: (default: `ReservoirDataType.USABLE_VOLUME`) Reservoir level data type. See [ReservoirDataType](@ref) for reference.
