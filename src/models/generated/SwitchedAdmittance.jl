...
"""
    mutable struct SwitchedAdmittance <: ElectricLoad
        ...
        control_mode::SwitchedAdmittanceControlMode.T
...
- `control_mode::SwitchedAdmittanceControlMode.T`: (default: `SwitchedAdmittanceControlMode.FIXED`) Switched-shunt control mode.
