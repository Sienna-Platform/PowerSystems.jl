...
"""Get [`PhaseShiftingTransformer`](@ref) `active_power_flow`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_active_power_flow(value::PhaseShiftingTransformer) = get_value(value, Val(:active_power_flow), Val(:mva), DEFAULT_UNITS)
get_active_power_flow(value::PhaseShiftingTransformer, units) = get_value(value, Val(:active_power_flow), Val(:mva), units)
"""Get [`PhaseShiftingTransformer`](@ref) `reactive_power_flow`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_reactive_power_flow(value::PhaseShiftingTransformer) = get_value(value, Val(:reactive_power_flow), Val(:mva), DEFAULT_UNITS)
...
"""Get [`PhaseShiftingTransformer`](@ref) `r`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_r(value::PhaseShiftingTransformer) = get_value(value, Val(:r), Val(:ohm), DEFAULT_UNITS)
get_r(value::PhaseShiftingTransformer, units) = get_value(value, Val(:r), Val(:ohm), units)
"""Get [`PhaseShiftingTransformer`](@ref) `x`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_x(value::PhaseShiftingTransformer) = get_value(value, Val(:x), Val(:ohm), DEFAULT_UNITS)
get_x(value::PhaseShiftingTransformer, units) = get_value(value, Val(:x), Val(:ohm), units)
"""Get [`PhaseShiftingTransformer`](@ref) `primary_shunt`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_primary_shunt(value::PhaseShiftingTransformer) = get_value(value, Val(:primary_shunt), Val(:siemens), DEFAULT_UNITS)
...
"""Get [`PhaseShiftingTransformer`](@ref) `rating`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_rating(value::PhaseShiftingTransformer) = get_value(value, Val(:rating), Val(:mva), DEFAULT_UNITS)
...
"""Get [`PhaseShiftingTransformer`](@ref) `rating_b`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_rating_b(value::PhaseShiftingTransformer) = get_value(value, Val(:rating_b), Val(:mva), DEFAULT_UNITS)
get_rating_b(value::PhaseShiftingTransformer, units) = get_value(value, Val(:rating_b), Val(:mva), units)
"""Get [`PhaseShiftingTransformer`](@ref) `rating_c`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_rating_c(value::PhaseShiftingTransformer) = get_value(value, Val(:rating_c), Val(:mva), DEFAULT_UNITS)
