...
"""
    mutable struct FACTSControlDevice <: StaticInjection
        ...
        available::Bool
        bus::ACBus
        control_mode::Union{Nothing, FACTSOperationModes.T}
        voltage_setpoint::Float64
        max_shunt_current::Float64
        max_reactive_power::Float64
        shunt_control_type::FACTSShuntControlType.T
...
- `control_mode::Union{Nothing, FACTSOperationModes.T}`: Control mode. Used to describe the behavior of the control device. [Options are listed here.](@ref factsmodes_list)
...
- `shunt_control_type::FACTSShuntControlType.T`: (default: `FACTSShuntControlType.STATCOM`) Device class selecting the reactive-limit law (SVC vs STATCOM)
