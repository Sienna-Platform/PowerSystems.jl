...
function from_openapi(po::PO.InterruptiblePowerLoad, refs::OpenAPIRefs, ::ComponentBaseUnit)
...
function to_openapi(value::InterruptiblePowerLoad, refs::OpenAPIRefs, ::ComponentBaseUnit)
