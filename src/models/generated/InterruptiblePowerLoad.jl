...
"""Get [`InterruptiblePowerLoad`](@ref) `active_power`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_active_power(value::InterruptiblePowerLoad) = get_value(value, Val(:active_power), Val(:mva), DEFAULT_UNITS)
get_active_power(value::InterruptiblePowerLoad, units) = get_value(value, Val(:active_power), Val(:mva), units)
"""Get [`InterruptiblePowerLoad`](@ref) `reactive_power`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_reactive_power(value::InterruptiblePowerLoad) = get_value(value, Val(:reactive_power), Val(:mva), DEFAULT_UNITS)
get_reactive_power(value::InterruptiblePowerLoad, units) = get_value(value, Val(:reactive_power), Val(:mva), units)
"""Get [`InterruptiblePowerLoad`](@ref) `max_active_power`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_max_active_power(value::InterruptiblePowerLoad) = get_value(value, Val(:max_active_power), Val(:mva), DEFAULT_UNITS)
get_max_active_power(value::InterruptiblePowerLoad, units) = get_value(value, Val(:max_active_power), Val(:mva), units)
"""Get [`InterruptiblePowerLoad`](@ref) `max_reactive_power`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_max_reactive_power(value::InterruptiblePowerLoad) = get_value(value, Val(:max_reactive_power), Val(:mva), DEFAULT_UNITS)
