...
"""
    mutable struct ThreeWindingTransformer <: ACTransmission
        ...
        shunt_location::ThreeWindingTransformerShuntLocation.T
...
- `r_12::Union{Nothing, Float64}`: (default: `nothing`) Measured resistance in pu (component base on `base_power_12`), referenced to the primary winding's base voltage, from primary to secondary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`., validation range: `(0, 4)`
- `x_12::Union{Nothing, Float64}`: (default: `nothing`) Measured reactance in pu (component base on `base_power_12`), referenced to the primary winding's base voltage, from primary to secondary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`., validation range: `(0, 4)`
- `r_23::Union{Nothing, Float64}`: (default: `nothing`) Measured resistance in pu (component base on `base_power_23`), referenced to the secondary winding's base voltage, from secondary to tertiary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`., validation range: `(0, 4)`
- `x_23::Union{Nothing, Float64}`: (default: `nothing`) Measured reactance in pu (component base on `base_power_23`), referenced to the secondary winding's base voltage, from secondary to tertiary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`., validation range: `(0, 4)`
- `r_31::Union{Nothing, Float64}`: (default: `nothing`) Measured resistance in pu (component base on `base_power_31`), referenced to the tertiary winding's base voltage, from tertiary to primary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`., validation range: `(0, 4)`
- `x_31::Union{Nothing, Float64}`: (default: `nothing`) Measured reactance in pu (component base on `base_power_31`), referenced to the tertiary winding's base voltage, from tertiary to primary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`., validation range: `(0, 4)`
...
- `shunt_location::ThreeWindingTransformerShuntLocation.T`: (default: `ThreeWindingTransformerShuntLocation.PRIMARY`) Placement of `magnetizing_shunt` in the equivalent star model. See [`ThreeWindingTransformerShuntLocation`](@ref)
...
mutable struct ThreeWindingTransformer <: ACTransmission
    ...
    star_bus::ACBus
    "Measured resistance in pu (component base on `base_power_12`), referenced to the primary winding's base voltage, from primary to secondary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`."
    r_12::Union{Nothing, Float64}
    "Measured reactance in pu (component base on `base_power_12`), referenced to the primary winding's base voltage, from primary to secondary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`."
    x_12::Union{Nothing, Float64}
    "Measured resistance in pu (component base on `base_power_23`), referenced to the secondary winding's base voltage, from secondary to tertiary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`."
    r_23::Union{Nothing, Float64}
    "Measured reactance in pu (component base on `base_power_23`), referenced to the secondary winding's base voltage, from secondary to tertiary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`."
    x_23::Union{Nothing, Float64}
    "Measured resistance in pu (component base on `base_power_31`), referenced to the tertiary winding's base voltage, from tertiary to primary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`."
    r_31::Union{Nothing, Float64}
    "Measured reactance in pu (component base on `base_power_31`), referenced to the tertiary winding's base voltage, from tertiary to primary windings. Not synced with the star-leg values after construction; see struct docstring. Optional; all pairwise measured-impedance fields must be set together or all be `nothing`."
    x_31::Union{Nothing, Float64}
