...
"""
    mutable struct TwoTerminalVSCLine <: TwoTerminalHVDC
        ...
        dc_control_from::VSCDCControlModes.T
        ac_control_from::VSCACControlModes.T
        ...
        dc_control_to::VSCDCControlModes.T
        ac_control_to::VSCACControlModes.T
...
- `dc_control_from::VSCDCControlModes.T`: (default: `VSCDCControlModes.DC_VOLTAGE`) DC-side control mode of the `from` converter; see [`VSCDCControlModes`](@ref).
- `ac_control_from::VSCACControlModes.T`: (default: `VSCACControlModes.AC_VOLTAGE`) AC-side control mode of the `from` converter; see [`VSCACControlModes`](@ref).
...
- `dc_control_to::VSCDCControlModes.T`: (default: `VSCDCControlModes.DC_VOLTAGE`) DC-side control mode of the `to` converter; see [`VSCDCControlModes`](@ref).
- `ac_control_to::VSCACControlModes.T`: (default: `VSCACControlModes.AC_VOLTAGE`) AC-side control mode of the `to` converter; see [`VSCACControlModes`](@ref).
