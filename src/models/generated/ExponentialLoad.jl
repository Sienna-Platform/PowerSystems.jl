...
function from_openapi(po::PO.ExponentialLoad, refs::OpenAPIRefs, ::ComponentBaseUnit)
...
function to_openapi(value::ExponentialLoad, refs::OpenAPIRefs, ::ComponentBaseUnit)
