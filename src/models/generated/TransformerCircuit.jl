...
"""
    mutable struct TransformerCircuit <: DeviceParameter
        ...
        r::Float64
        x::Float64
        control_objective::TransformerControlObjective.T
...
- `control_objective::TransformerControlObjective.T`: (default: `TransformerControlObjective.UNDEFINED`) Tap-changer / phase-shifter control objective. `UNDEFINED` means this circuit has no control block. See [`TransformerControlObjective`](@ref)
