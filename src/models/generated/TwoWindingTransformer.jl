...
"""
    mutable struct TwoWindingTransformer <: ACTransmission
        ...
        shunt_location::TwoWindingTransformerShuntLocation.Value
...
- `shunt_location::TwoWindingTransformerShuntLocation.Value`: (default: `TwoWindingTransformerShuntLocation.PRIMARY`) Placement of `magnetizing_shunt` on the two sides of the circuit arc. See [`TwoWindingTransformerShuntLocation`](@ref)
