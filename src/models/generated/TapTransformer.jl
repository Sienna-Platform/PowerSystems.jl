...
"""Get [`TapTransformer`](@ref) `active_power_flow`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_active_power_flow(value::TapTransformer) = get_value(value, Val(:active_power_flow), Val(:mva), DEFAULT_UNITS)
get_active_power_flow(value::TapTransformer, units) = get_value(value, Val(:active_power_flow), Val(:mva), units)
"""Get [`TapTransformer`](@ref) `reactive_power_flow`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_reactive_power_flow(value::TapTransformer) = get_value(value, Val(:reactive_power_flow), Val(:mva), DEFAULT_UNITS)
...
"""Get [`TapTransformer`](@ref) `r`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_r(value::TapTransformer) = get_value(value, Val(:r), Val(:ohm), DEFAULT_UNITS)
get_r(value::TapTransformer, units) = get_value(value, Val(:r), Val(:ohm), units)
"""Get [`TapTransformer`](@ref) `x`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_x(value::TapTransformer) = get_value(value, Val(:x), Val(:ohm), DEFAULT_UNITS)
get_x(value::TapTransformer, units) = get_value(value, Val(:x), Val(:ohm), units)
"""Get [`TapTransformer`](@ref) `primary_shunt`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_primary_shunt(value::TapTransformer) = get_value(value, Val(:primary_shunt), Val(:siemens), DEFAULT_UNITS)
...
"""Get [`TapTransformer`](@ref) `rating`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_rating(value::TapTransformer) = get_value(value, Val(:rating), Val(:mva), DEFAULT_UNITS)
...
"""Get [`TapTransformer`](@ref) `rating_b`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_rating_b(value::TapTransformer) = get_value(value, Val(:rating_b), Val(:mva), DEFAULT_UNITS)
get_rating_b(value::TapTransformer, units) = get_value(value, Val(:rating_b), Val(:mva), units)
"""Get [`TapTransformer`](@ref) `rating_c`. Returns value in DEFAULT_UNITS (system base per-unit)."""
get_rating_c(value::TapTransformer) = get_value(value, Val(:rating_c), Val(:mva), DEFAULT_UNITS)
