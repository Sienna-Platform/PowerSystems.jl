...
"""
    mutable struct EnergyReservoirStorage <: Storage
        ...
        storage_technology_type::StorageTech.Value
...
- `storage_technology_type::StorageTech.Value`: Storage Technology Complementary to EIA 923. Options are listed [here](@ref storagetech_list)
