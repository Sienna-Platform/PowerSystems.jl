...
# COMPONENT_MVAR-on-system-base quantity as `Y`, so it takes the same `base_power`
# division; `nothing` (the field is optional in the schema) passes through unscaled.
