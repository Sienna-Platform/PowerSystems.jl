...
@testset "Test component conversion" begin
    test_load_conversion =
        () -> begin
            ...
            set_max_reactive_power!(old_component, 0.123 * u"CU")
            old_max_p = get_max_active_power(old_component, u"CU")
            old_max_q = get_max_reactive_power(old_component, u"CU")
            ...
            @test get_max_constant_active_power(new_component, u"CU") == old_max_p
            @test get_max_constant_reactive_power(new_component, u"CU") == old_max_q
